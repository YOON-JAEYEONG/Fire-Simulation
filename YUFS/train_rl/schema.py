...
OBSERVATION_FIELDS = [
    ...
    ObservationField(12, "dist_to_nearest_shelter_normalized", "Distance to nearest shelter normalized by 10000 cm."),
    ObservationField(13, "nearby_evacuating_ratio", "Fraction of nearby NPCs currently evacuating."),
    ObservationField(14, "nearby_npc_count_normalized", "Nearby NPC count normalized by 20."),
    ObservationField(15, "group_size_normalized", "Nearby group size including self, normalized by 20."),
    ObservationField(16, "nearby_npc_needs_help", "1 when nearby social context suggests helping, else 0."),
    ObservationField(17, "alarm_sounding", "1 when alarm has reached the NPC, else 0."),
    ObservationField(18, "received_pre_recorded_message", "1 when prerecorded emergency message has been received."),
    ObservationField(19, "received_live_announcement", "1 when live emergency announcement has been received."),
    ObservationField(20, "received_staff_guidance", "1 when staff guidance has been received."),
    ObservationField(21, "staff_guided_exit_x_normalized", "Normalized X coordinate of staff-guided exit target."),
    ObservationField(22, "staff_guided_exit_y_normalized", "Normalized Y coordinate of staff-guided exit target."),
    ObservationField(23, "staff_guided_exit_z_normalized", "Normalized Z coordinate of staff-guided exit target."),
    ObservationField(24, "current_state_normalized", "Behavior state enum normalized by the max enum value."),
    ObservationField(25, "risk_perception", "State machine risk perception in [0, 1]."),
    ObservationField(26, "stress_level", "Current stress proxy copied from perception risk level."),
    ObservationField(27, "milling_action_count_normalized", "Milling action count normalized by 20."),
    ObservationField(28, "smoke_exposure_accumulated", "Accumulated smoke exposure in [0, 1]."),
]
