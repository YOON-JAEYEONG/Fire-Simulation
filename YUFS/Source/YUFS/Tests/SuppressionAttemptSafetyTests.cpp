...
bool FYUFSSuppressionRiskHysteresisTest::RunTest(const FString& Parameters)
{
    ...
    // Subtracting rounded float thresholds can exceed the default 1e-8 tolerance.
    TestTrue(TEXT("hysteresis band is 0.10"),FMath::IsNearlyEqual(Stop-Start,.10f,1.e-6f));
